...
use App\Models\ModelDictCoverage;
use Exception;
use Illuminate\Http\Request;

class ControllerDictCoverage extends Controller
{
    static public function getAll(){
        try{
            $all = ModelDictCoverage::all();
