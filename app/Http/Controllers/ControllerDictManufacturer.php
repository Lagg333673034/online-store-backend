...
use App\Models\ModelDictManufacturer;
use Exception;
use Illuminate\Http\Request;

class ControllerDictManufacturer extends Controller
{
    static public function getAll(){
        try{
            $all = ModelDictManufacturer::all();
    ...
    static public function getOne($id){
        try{
            $one = ModelDictManufacturer::find($id);
