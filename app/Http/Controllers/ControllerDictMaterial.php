...
use App\Models\ModelDictMaterial;
use Exception;
use Illuminate\Http\Request;

class ControllerDictMaterial extends Controller
{
    static public function getAll(){
        try{
            $all = ModelDictMaterial::all();
