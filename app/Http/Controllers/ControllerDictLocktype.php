...
use App\Models\ModelDictLocktype;
use Exception;
use Illuminate\Http\Request;

class ControllerDictLocktype extends Controller
{
    static public function getAll(){
        try{
            $all = ModelDictLocktype::all();
